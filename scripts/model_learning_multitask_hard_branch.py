...
def create_model(input_size, num_classes_1, num_classes_2, batch_size, combining_weight, weight_flag, ratio=1.0, percent_share=None): #, input_tag
    ...
    conv1_mask_task1 = RepeatVector(int(conv1_dim * (1.0 - percent_share[0])/2.0), name='conv1_task1')(conv1_mask_base)
    ...
    conv1_mask_task2 = RepeatVector(int(conv1_dim * (1.0 - percent_share[0])/2.0), name='conv1_task2')(conv1_mask_base)
    ...
    conv2_mask_task1 = RepeatVector(int(conv2_dim * (1.0 - percent_share[1])/2.0), name='conv2_task1')(conv2_mask_base)
    ...
    conv2_mask_task2 = RepeatVector(int(conv2_dim * (1.0 - percent_share[1])/2.0), name='conv2_task2')(conv2_mask_base)
    ...
    conv3_mask_task1 = RepeatVector(int(conv3_dim * (1.0 - percent_share[2])/2.0), name='conv3_task1')(conv3_mask_base)
    ...
    conv3_mask_task2 = RepeatVector(int(conv3_dim * (1.0 - percent_share[2])/2.0), name='conv3_task2')(conv3_mask_base)
    ...
    fc1_mask_task1 = Reshape((int(fc1_dim * (1.0 - percent_share[3])/2.0),), name='fc1_task1')(RepeatVector(int(fc1_dim * 0.175))(custom_mask_in))
    fc1_mask_task1 = Masking(mask_value=2, name='fc1_mask_task1')(fc1_mask_task1) 
    fc1_mask_task2 = Reshape((int(fc1_dim * (1.0 - percent_share[3])/2.0),), name='fc1_task2')(RepeatVector(int(fc1_dim * 0.175))(custom_mask_in)) 
    ...
    fc2_mask_task1 = Reshape((int(fc2_dim * (1.0 - percent_share[4])/2.0),), name='fc2_task1')(RepeatVector(int(fc2_dim * 0.2))(custom_mask_in))
    fc2_mask_task1 = Masking(mask_value=2, name='fc2_mask_task1')(fc2_mask_task1) 
    fc2_mask_task2 = Reshape((int(fc2_dim * (1.0 - percent_share[4])/2.0),), name='fc2_task2')(RepeatVector(int(fc2_dim * 0.2))(custom_mask_in)) 
