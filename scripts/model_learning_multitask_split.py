...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 26 15:46:02 2019
...
# Version 2.1: Keep the human/mouse ratio in all the batches
...
def create_model(input_size, num_classes_1, num_classes_2, batch_size, combining_weight, weight_flag, ratio=1.0, percent_share=None): #, input_tag
    ...
    nn = Conv1D(filters=300, kernel_size=19, padding='same', name='conv_1')(inputs)
...
# predicted_labels = model.predict([test_features, test_labels>0.0])
